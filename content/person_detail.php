...
<div>
  <table class="table table-striped table-bordered">
    ...
    <tbody>
      <?php
       $sql = "SELECT * FROM person join company join job join address join person_address on person.person_id = job.person_id AND company.company_id = job.company_id and person_address.address_id = address.address_id ANd person_address.person_id = person.person_id";
